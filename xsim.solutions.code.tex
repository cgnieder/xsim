...
\bool_new:N \l__xsim_printsolutions_collection_bool
...
% #1: type
% #2: id
\cs_new_protected:Npn \xsim_add_solution:nn #1#2
  { \xsim_add_to_list:nn {solutions} {#1-#2} }
\cs_generate_variant:Nn \xsim_add_solution:nn {nV}

\prg_new_conditional:Npnn \xsim_if_solution_exists:nn #1#2 {T,F,TF}
  {
    \xsim_if_in_list:nnTF {solutions} {#1-#2}
      { \prg_return_true: }
      { \prg_return_false: }
  }
...
\cs_new_protected:Npn \xsim_start_solution:nn #1#2
  {
    ...
    \xsim_add_solution:nV {#1} \ExerciseID
  }
...
\keys_define:nn {xsim/print-solutions}
  {
    ...
    collection/false  .code:n     =
      \bool_set_false:N \l__xsim_printsolutions_collection_bool ,
    collection/unknown .code:n    =
      \xsim_if_collection_exists:nT {#1}
        {
          \bool_set_true:N \l__xsim_printsolutions_collection_bool
...
% #2: id
% #3: use|print
\prg_new_protected_conditional:Npnn \__xsim_if_solutions_per_section:nnn #1#2#3 {T,F,TF}
  {
    \xsim_if_in_list:nnTF {#3} {#1-#2=={true}}
      {
        \bool_if:NTF \l__xsim_printsolutions_section_bool
          {
...
% #2: id
% #3: use|print
\prg_new_protected_conditional:Npnn \__xsim_if_solutions_per_chapter:nnn #1#2#3 {T,F,TF}
  {
    \xsim_if_in_list:nnTF {#3} {#1-#2=={true}}
      {
        \bool_if:NTF \l__xsim_printsolutions_chapter_bool
          {
            \__xsim_printsolutions_condition_true:
...
% #2: id
% #3: use|print
\prg_new_protected_conditional:Npnn \__xsim_if_solutions_in_collection:nnn #1#2#3 {T,F,TF}
  {
    \xsim_if_in_list:nnTF {#3} {#1-#2=={true}}
      {
        \bool_if:NTF \l__xsim_printsolutions_collection_bool
          {
            \__xsim_printsolutions_condition_true:
...
\AtEndDocument { \xsim_update_list:n {solutions} }
