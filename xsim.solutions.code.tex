...
\cs_new_protected:Npn \xsim_print_type_solutions:n #1
  {
    \group_begin:
      ...
      \int_do_until:nn { \l__xsim_tmpa_int = \g_xsim_max_id_int }
        {
          \int_incr:N \l__xsim_tmpa_int
          \tl_set:Nx \l__xsim_tmpa_tl { \int_use:N \l__xsim_tmpa_int }
          \xsim_if_in_list:nxT {print} { #1 -\l__xsim_tmpa_tl }
            { \xsim_insert_solution:nV {#1} \l__xsim_tmpa_tl }
        }
    \group_end:
  }
