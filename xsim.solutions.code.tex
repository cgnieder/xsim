...
% #2: id
% #3: options
\cs_new_protected:Npn \xsim_insert_solution:nnn #1#2#3
  {
...
\cs_generate_variant:Nn \xsim_insert_solution:nnn {nV}
      ...
      \bool_if:NT \l__xsim_tmpa_bool
        {
          ...
          \xsim_foreach_exercise_type_id:nn {use}
            { \xsim_insert_solution:nnn {#3} {##2} {#2} }
        }
    \group_end:
  }
