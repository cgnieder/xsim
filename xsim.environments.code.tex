...
\tl_const:Nn \c__xsim_comment_line_indent_tl
...
% #3: exercise|solution
% #4: file name
\cs_new_protected:Npn \__xsim_file_info:nnnn #1#2#3#4
  {
...
\cs_generate_variant:Nn \__xsim_file_info:nnnn {nnnV}
...
\cs_new_protected:Npn \xsim_save_environment_body:nnn #1#2#3
  {
    ...
    \__xsim_file_info:nnnV {#1} {#2} {#3} \l_xsim_file_name_tl
    ...
    \use:x
      {
        ...
        \file_if_exist:nTF { \exp_not:V \l_xsim_file_name_tl }
