...
\cs_generate_variant:Nn \xsim_if_property_set:nnnF  {nnx}
...
\cs_new_protected:Npn \xsim_property_set_alias:nnn #1#2#3
  {
    \xsim_if_property_set:nnnF {#1} {#2} {#3}
      {
        \xsim_if_property_set:nnxF {#1} {#2}
          { \xsim_property_alias:n {#3} }
          { 
            \xsim_set_property:nnnx {#1} {#2} {#3}
              {
                \xsim_get_property:nnn {#1} {#2}
                  { \xsim_property_alias:n {#3} }
              }
          }
      }
...
\cs_generate_variant:Nn \xsim_get_property:nnn {nx,xx,oo,no}
