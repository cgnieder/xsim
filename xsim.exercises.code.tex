...
\xsim_declare_parameter:nnn {true}  {true}  {exercise-env}
\xsim_declare_parameter:nnn {true}  {true}  {solution-env}
\xsim_declare_parameter:nnn {false} {true}  {exercise-name}
\xsim_declare_parameter:nnn {false} {true}  {solution-name}
\xsim_declare_parameter:nnn {false} {true}  {exercise-template}
\xsim_declare_parameter:nnn {false} {true}  {solution-template}
\xsim_declare_parameter:nnn {false} {false} {counter}
\xsim_declare_parameter:nnn {true}  {false} {number}
