...
\gradingtable[template=horizontal,type=exercise] \par \bigskip

\gradingtable[template=horizontal,type=problem] \par \bigskip

\gradingtable[template=horizontal] \par \bigskip
