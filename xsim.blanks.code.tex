...
\cs_new:Npn \xsim_write_blank:n #1 {#1}
\cs_set_eq:NN \xsim_write_blank:n \uline
...
\keys_define:nn { xsim / blank }
  {
    ...
    style / line   .code:n =
      \cs_set_eq:NN \xsim_write_blank:n \uline ,
    style / wave   .code:n =
      \cs_set_eq:NN \xsim_write_blank:n \uwave ,
    style / dline  .code:n =
      \cs_set_eq:NN \xsim_write_blank:n \uuline ,
    style / dotted .code:n =
      \cs_set_eq:NN \xsim_write_blank:n \dotuline ,
    style / dashed .code:n =
      \cs_set_eq:NN \xsim_write_blank:n \dashuline ,
    ...
    line-increment .dim_set:N =
      \l__xsim_blank_line_increment_dim ,
    line-increment .initial:n = 1pt ,
    line-minimum-length .dim_set:N =
      \l__xsim_blank_line_minimum_length_dim ,
    ...
    \bool_if:NTF \l__xsim_inside_solution_bool
      { \xsim_write_blank:n {#1} }
      {
        \bool_if:NTF \l__xsim_blank_width_bool
          { \__xsim_blank_skip:N \l__xsim_blank_dim }
          {
            \__xsim_blank_skip:n
              { \box_wd:N \l__xsim_blank_box }
          }
      }
  }
...
\cs_generate_variant:Nn \__xsim_blank_skip:N { n }
