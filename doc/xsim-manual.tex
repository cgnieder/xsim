...
\begin{itemize}
  \item where the environment is placed in the document the \emph{base setup}
    happens: this sets the \property{id} of the exercise and sets the
    properties chosen in the optional argument.
  \item in the default setup also the \emph{usage setup} happens: this
  ...
  \item in the default setup also the \emph{print setup} happens: this mostly
    does nothing except printing the exercise.
\end{itemize}
...
for example as part of a collection, see~\vref{sec:collecting-exercises}.
...
\begin{commands}
  \command{activatecollection}[\marg{collection name}]
    ...
    exercises until the collection is deactivated. \meta{collection name} can
    be a csv list of collection names.
  \command{deactivatecollection}[\marg{collection name}]
    Deactivates the collection \meta{collection name}.  \meta{collection name}
