...
\NewDocumentCommand \ForEachExerciseByType {+m}
  { \xsim_foreach_exercise_type_id:n {#1} }

\NewDocumentCommand \ForEachExerciseByID {+m}
  { \xsim_foreach_exercise_id_type:n {#1} }
...
\NewDocumentCommand \printsolutionstype {O{}m}
  { \xsim_print_type_solutions:nn {#1} {#2} }

\NewDocumentCommand \printsolutions {O{}}
  { \xsim_print_all_solutions:n {#1} }
