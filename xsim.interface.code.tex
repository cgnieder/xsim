...
\NewDocumentCommand \ForeachExerciseTag {+m}
  { \xsim_foreach_exercise_tag:oon {\ExerciseType} {\ExerciseID} {#1} }

\NewDocumentCommand \ExerciseTagsUse {m}
  { \xsim_exercise_tags_use:oon {\ExerciseType} {\ExerciseID} {#1} }

\NewDocumentCommand \ExerciseTagsUseX {mmm}
  { \xsim_exercise_tags_use:oonnn {\ExerciseType} {\ExerciseID} {#1} {#2} {#3} }
