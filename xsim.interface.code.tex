...
\DeclareExpandableDocumentCommand \IfExercisePropertyTF {+m+m+m}
...
% based upon the predefind tagging class `tags':
\NewDocumentCommand \ForeachExerciseTag {+m}
  { \xsim_foreach_exercise_tag:oonn {\ExerciseType} {\ExerciseID} {tags} {#1} }

\NewDocumentCommand \ExerciseTagsUse {m}
  { \xsim_exercise_tags_use:oonn {\ExerciseType} {\ExerciseID} {tags} {#1} }

\NewDocumentCommand \ExerciseTagsUseX {mmm}
  { \xsim_exercise_tags_use:oonnnn {\ExerciseType} {\ExerciseID} {tags} {#1} {#2} {#3} }
