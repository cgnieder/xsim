...
\NewDocumentCommand \UseExerciseTags {mm}
  { \xsim_exercise_tags_use:oonn {\ExerciseType} {\ExerciseID} {#1} {#2} }

\NewDocumentCommand \UseExerciseTagsX {mmmm}
  {
...
\NewDocumentCommand \NewExerciseCollection {m}
  { \xsim_new_collection:n {#1} }
  
\NewDocumentCommand \collectexercisestype {O{}mm}
  { \xsim_start_collection:nnn {#1} {#2} {#3} }

\NewDocumentCommand \collectexercises {O{}m}
