...
\NewDocumentCommand \DeclareExerciseCollection {O{}m}
  {
...
\NewDocumentCommand \collectexercisestype {}
  { \xsim_remove:nN {0.20} \collectexercisestype }

\NewDocumentCommand \collectexercises {}
  { \xsim_remove:nN {0.20} \collectexercises}

\NewDocumentCommand \collectexercisesstop {}
  { \xsim_remove:nN {0.20} \collectexercisesstop }
