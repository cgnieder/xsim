...
% #2: id
% #3: property
\cs_new_protected:Npn \____xsim_define_property:nnn #1#2#3
  { \cs_new:cpn {____xsim_property_ \tl_to_str:n {#1!#2!#3} :} {} }

% #1: type
% #2: id
% #3: property
\cs_new_protected:Npn \____xsim_set_property:nnnn #1#2#3#4
  { \cs_set:cpn {____xsim_property_ \tl_to_str:n {#1!#2!#3} :} {#4} }

% #1: type
% #2: id
% #3: property
\cs_new_protected:Npn \____xsim_unset_property:nnn #1#2#3
  { \cs_undefine:c {____xsim_property_ \tl_to_str:n {#1!#2!#3} :} }

% #1: type
% #2: id
% #3: property
\cs_new:Npn \____xsim_get_property:nnn #1#2#3
  { \cs_if_exist_use:c {____xsim_property_ \tl_to_str:n {#1!#2!#3} :} }
...
\prg_new_conditional:Npnn \xsim_if_property_set:nnn #1#2#3 {p,T,F,TF}
  {
    \cs_if_exist:cTF {____xsim_property_ \tl_to_str:n {#1!#2!#3} :}
      { \prg_return_true: }
      { \prg_return_false: }
  }
...
\cs_new_protected:Npn \__xsim_set_property:nnnn #1#2#3#4
  {
    ...
    \____xsim_set_property:nnnn {#1} {#2} {#3} {#4}
  }
...
\cs_new_protected:Npn \__xsim_unset_property:nnn #1#2#3
  {
    ...
    \__xsim_remove_property_from_list:nnn {#1} {#2} {#3}
    \____xsim_unset_property:nnn {#1} {#2} {#3}
  }
...
\cs_new:Npn \xsim_get_property:nnn #1#2#3
  { \____xsim_get_property:nnn {#1} {#2} {#3} }
