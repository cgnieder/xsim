...
% #2: goal
% #3: value
\cs_new_protected:Npn \xsim_addto_goal:nnn #1#2#3
  {
    \xsim_if_goal_exists:nT {#2}
      {
        \fp_gadd:cn {g__xsim_goal_#2_fp} {#3}
        \fp_gadd:cn {g__xsim_#1_goal_#2_fp} {#3}
      }
  }
\cs_generate_variant:Nn \xsim_addto_goal:nnn {x}
