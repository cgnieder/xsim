...
\tl_const:Nn \c__xsim_comment_line_fill_tl { \prg_replicate:nn {48} {-} }
...
\tl_set:Nn \l_xsim_file_path_and_name_tl
  {
    \tl_if_blank:VF \l_xsim_file_path_tl { \l_xsim_file_path_tl / }
    \l_xsim_file_name_tl
  }
...
\cs_new_protected:Npn \xsim_input:nnn #1#2#3
  {
    ...
    \xsim_if_write_to_files:TF
      {
        \file_if_exist:nTF { \exp_not:V \l_xsim_file_path_and_name_tl }
          { \file_input:n { \exp_not:V \l_xsim_file_path_and_name_tl } }
          {
            \xsim_verbose:n
