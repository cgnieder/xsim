...
\begin{properties}
  \propert{id} holds the internal id of an exercise.
  \propert{ID} holds the user id of an exercise if defined.  Otherwise it is equal
    to \property{id}.
  \propert{counter} holds the counter value of an exercise.
  \propert{subtitle} holds the subtitle of an exercise.
...
\section{Difference between Printing and Using an Exercise}
